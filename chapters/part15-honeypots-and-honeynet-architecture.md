...
The table below extends Appendix A4's general pre-flight checklist with five checks specific to a honeynet build — run these in addition to, not instead of, the full appendix procedure. Appendix A4 is not yet authored (see `README.md`); until it is, treat Part 4 §6's isolation checks as that general procedure.
